...
if ($result->rowCount() > 0) {
    ...
    foreach ($result as $row) {
        ...
        echo "<td><a href='" . BASE_URL . "dashboard/turmas/" . $row["id"] . "' onclick='return confirm(\"Tem certeza de que deseja excluir a turma?\")'><i class='fas fa-trash-alt' style='color: #B30000;'></i>
                </a></td>";
    }
    echo "</table>";
    echo "</div>";
