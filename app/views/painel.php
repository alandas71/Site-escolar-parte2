...
<div class="header" style="text-align: left; padding-left: 20px; background: none;">
    ...
    <div class="delete">
        ...
        foreach ($resultadoBanners as $row) : ?>
            <div>
                <img style="height: 100px; width: 300px;" src="<?php echo BASE_URL ?>assets/images/banners/<?php echo $row['imagem']; ?>">
                <form method="post">
                    ...
                    <input type="submit" name="excluir_banner" value="Excluir" onclick="return confirm('Tem certeza de que deseja remover este banner?')">
                </form>
            </div>
        <?php endforeach; ?>
    </div>
        ...
        <?php foreach ($resultadoProf as $row) : ?>
            <div>
                ...
                <form method="post">
                    ...
                    <input type="submit" name="excluir_prof" value="Excluir" onclick="return confirm('Tem certeza de que deseja remover essa professora?')">
                </form>
            </div>
        <?php endforeach; ?>
    </div>
        ...
        <?php foreach ($resultadoDepoimentos as $row) : ?>
            <div>
                ...
                <form method="post">
                    ...
                    <input type="submit" name="excluir_depoimentos" value="Excluir" onclick="return confirm('Tem certeza de que deseja remover este depoimento?')">
                </form>
            </div>
        <?php endforeach; ?>
    </div>
